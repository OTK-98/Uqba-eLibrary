...
import '../../../widget/book/operator/custom_update_dropdownmenu.dart';
...
class EditBookScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (book != null) {
      ...
      bookController.description.text = book!.description ?? "";
      bookController.publisher.text = book!.publisher ?? "";
      bookController.edition.text = book!.edition ?? "";
      bookController.pages.text = book!.pages.toString();
      bookController.selectedPavillonId.value = book!.subCategoryId ?? "";
      bookController.selectedPavillonTitle.value = book!.pavilion ?? "";
      bookController.selectedCategoryId.value = book!.categoryId ?? "";
      bookController.selectedCategoryTitle.value = book!.category ?? "";
      bookController.wardrobe.text = book!.wardrobe.toString();
      bookController.shelf.text = book!.shelf.toString();
      bookController.code.text = book!.code.toString();
      bookController.imageUrl.value = book!.coverUrl ?? "";
      bookController.pdfUrl.value = book!.bookurl ?? "";
    }
